# Generated for the Insider-Driven Data Leakage Detection and Prevention System.
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("name", models.CharField(choices=[("admin", "Admin"), ("security_officer", "Security Officer"), ("normal_user", "Normal User")], max_length=60, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ("id", models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name="ID")),
                ("action", models.CharField(choices=[("access", "File Access"), ("download", "File Download"), ("upload", "File Upload"), ("modify", "Data Modification"), ("share", "Data Sharing"), ("transfer", "Transfer Attempt"), ("failed_access", "Failed Access")], max_length=30)),
                ...
                ("file", models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to="core.sensitivefile")),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("activity_log", models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name="alerts", to="core.activitylog")),
                ("rule", models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to="core.detectionrule")),
